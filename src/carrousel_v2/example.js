...
//     for (var i = 0; i < _.totalSlides; i++) {if (window.CP.shouldStopExecution(0)) break;
...
//     for (var _i = 0; _i < _.totalSlides + 2; _i++) {if (window.CP.shouldStopExecution(1)) break;
...
//     for (var j = 0; j < _.totalSlides; j++) {if (window.CP.shouldStopExecution(2)) break;
...
//       _.def.target.style.height = _.allSlides[_.curSlide].offsetHeight + "px";
//     } else {
//       for (var i = 0; i < _.totalSlides + 2; i++) {if (window.CP.shouldStopExecution(3)) break;
